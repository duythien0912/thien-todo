...
///  * [Switch], a widget with semantics similar to [RadiusCheckBox].
///  * [Radio], for selecting among a set of explicit values.
///  * [Slider], for selecting a value in a range.
///  * <https://material.io/design/components/selection-controls.html#checkboxes>
///  * <https://material.io/design/components/lists.html#types>
class RadiusCheckBox extends StatefulWidget {
  ...
  ///
  /// RadiusCheckBox displays a dash when its value is null.
  ///
  ...
  static const double width = 26.0;
...
const double _kEdgeSize = RadiusCheckBox.width;
...
class _RenderCheckbox extends RenderToggleable {
  ...
  // At t == 0.0, the outer rect's size is _kEdgeSize (RadiusCheckBox.width)
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    const Offset start = Offset(_kEdgeSize * 0.2, _kEdgeSize * 0.48);
    const Offset mid = Offset(_kEdgeSize * 0.45, _kEdgeSize * 0.7);
    const Offset end = Offset(_kEdgeSize * 0.80, _kEdgeSize * 0.25);
    if (t < 0.5) {
      ...
      final double strokeT = (t - 0.55) * 2.0;
